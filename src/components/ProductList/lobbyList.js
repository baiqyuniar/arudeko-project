const studioList = {
  ...
  pictures: [
    {
      src: require("../../assets/IL1.png"),
      alt: "Interior Lobby Apartment 1",
    },
    {
      src: require("../../assets/IL2.png"),
      alt: "Interior Lobby Apartment 2",
    },
    {
      src: require("../../assets/IL3.png"),
      alt: "Interior Lobby Apartment 3",
    },
  ],
};
