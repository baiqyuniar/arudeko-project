        ...
        <div className="lg:mt-24">
          ...
          <div className="mx-8">
            <div className="flex my-12">
              ...
              <p className="text-lg lg:ml-4">
                <span className="font-bold my-4">Shunda Head Office </span>
                <br />
                Jl. Jembatan Tiga Komplek 35/O, <br />
                Jakarta Utara <br />
                14440
              </p>
            </div>
          ...
          <div className="mx-8">
            <div className="flex my-12">
              ...
              <p className="text-lg lg:ml-4">+62216625351</p>
            </div>
          </div>
          ...
          <div className="mx-8 mb-4">
            <div className="flex">
              ...
              <p className="text-lg lg:ml-4">+62216625356</p>
            </div>
          </div>
        </div>
      </div>
