...
const Footer = () => {
  ...
  return (
    <footer class="bg-black font-poppins bg-footer text-white">
      <div class="container w-full px-4 py-16 mx-auto sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 gap-8 lg:grid-cols-3">
          <div className=" flex flex-col justify-center">
            <img
              src={require("../assets/Logo.png")}
              class="mr-5 lg:h-32 lg:w-48 h-16 w-24"
              alt="logo"
            />
            <p class="max-w-xs mt-4 text-base text-white">
              <span className="font-bold">Shunda Head Office</span>
              <br />
              Jl. Jembatan Tiga
              <br />
              Komplek 35/O, Jakarta Utara
              <br />
              14440
            </p>
          ...
          <div class="grid grid-cols-2 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-3 text-white">
            <div>
              <p class="font-bold">Company Overview</p>
            ...
            <div>
              <nav class="flex flex-col mt-10 space-y-2 text-sm">
                <a class="hover:opacity-75 hover:cursor-pointer" href="/">
        ...
        <p class="mt-8 text-xs text-white text-center">
          © Copyright 2015, PT SHUNDA SUCAI INDONESIA, All rights reserved.
