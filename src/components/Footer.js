...
const Footer = () => {
  ...
  return (
    <footer class="font-poppins bg-footer text-black">
      <div class="container w-full px-4 py-8 mx-auto sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 gap-8 lg:grid-cols-3">
          <div className=" flex flex-col justify-center">
            <img
              ...
              alt="logo"
            />
            <p class="max-w-xs mt-4 text-base text-black">
          ...
          <div class="grid grid-cols-2 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-3 text-black">
            <div>
        ...
        <p class="mt-8 text-xs font-semibold text-black text-center">
