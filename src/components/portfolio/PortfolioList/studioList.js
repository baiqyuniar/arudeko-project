const studioList = {
  name: "Interior Kamar Type Studio",
  description:
  ...
  pictures: [
    {
      src: require("../../../assets/studio1.png"),
      alt: "Interior Kamar Type Studio 1",
    },
    {
      src: require("../../../assets/studio2.png"),
      alt: "Interior Kamar Type Studio 2",
    },
    {
      src: require("../../../assets/studio3.png"),
      alt: "Interior Kamar Type Studio 3",
    },
    {
      src: require("../../../assets/studio4.png"),
      alt: "Interior Kamar Type Studio 4",
    },
  ],
};
