...
import perumahanList from "../ProductList/perumahanList";
        ...
        <div className="flex flex-col lg:flex-row">
          <div className="py-8 w-full lg:mt-12 flex flex-col items-center">
            <div className="w-auto h-56 sm:h-72 lg:h-full max-h-96 overflow-hidden">
              <img
                src={perumahanList.pictures[mainPicture].src}
                alt={perumahanList.pictures[mainPicture].alt}
