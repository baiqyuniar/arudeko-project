...
import kantorList from "../ProductList/kantorList";
        ...
        <div className="flex flex-col lg:flex-row">
          <div className="py-8 w-full lg:mt-12 flex flex-col items-center">
            <div className="w-auto h-56 sm:h-72 lg:h-full max-h-96 overflow-hidden">
              <img
                src={kantorList.pictures[mainPicture].src}
                alt={kantorList.pictures[mainPicture].alt}
            ...
            <div className="mt-6 mx-auto">
              <ul className="grid grid-flow-col auto-cols-fr gap-4">
                {kantorList.pictures.slice(0, 4).map((picture, index) => (
                  <li
                    key={picture.alt}
