...
const Hero = () => {
  ...
  return (
    <section id="hero" className="w-full">
      <div className="absolute z-10 mt-24 container ml-80">
        <div className="mx-auto pt-10 sm:pt-20 w-full flex flex-col lg:flex-row">
        ...
        <div className="mt-14 mb-24 bg-[#F2D07A] p-5 w-full grid grid-cols-12 sm:grid-cols-4 gap-2 text-xs md:text-sm">
          <div
      ...
      <Fade {...props}>
        {sliderData.map((sliderData, index) => (
          <div className="items-center mt-20" key={index}>
