...
const HomeScreen = () => {
  ...
  return (
    <div className="w-full body-font font-poppins shadow-sm">
      <Header />
      {/* <p className="font-poppins text-center p-2 mb-4 font-bold">
        We are the Best Indonesian Brand Leader in Manufacturing and
        Distribution of Building Materials
      </p> */}
      {/* Banner */}
      {/* <img className="w-full" src={require("../assets/img1.png")} /> */}
      {/* <div class="w-full">
      ...
      {/* <section
        id="list"
        class="w-full my-4 mx-auto px-4 md:px-12 bg-[#F8C445] bg-opacity-50 py-8"
      >
        <div class="container flex flex-wrap mx-auto my-4 lg:mt-4 pb-14">
          <div class="my-1 px-1 w-full md:w-1/2 lg:my-16 lg:px-4 lg:w-1/4">
            <div class="overflow-hidden rounded-lg border border-dashed border-slate-600 shadow-lg">
              <div class="flex items-center justify-center leading-tight p-2 md:p-4">
                <h1 class="text-lg font-bold text-center">List of Products</h1>
              </div>
              <a href="#">
                <img
                  alt="Placeholder"
                  class="block h-auto w-full p-2 rounded-md"
          ...
          <div class="my-1 px-1 w-full md:w-1/2 lg:my-16 lg:px-4 lg:w-1/4">
            <div class="overflow-hidden rounded-lg border border-gray-900 shadow-lg">
              <div class="flex items-center justify-center leading-tight p-2 md:p-4">
                <h1 class="text-lg font-bold text-center">Our Networks</h1>
              </div>
              <img
                class="block h-auto w-full p-2 rounded-md"
                src="https://picsum.photos/600/400/?random"
          ...
          <div class="my-1 px-1 w-full md:w-1/2 lg:my-16 lg:px-4 lg:w-1/4">
            <div class="overflow-hidden h-full rounded-lg shadow-lg">
              <img
                alt="Placeholder"
      ...
      <section
        id="hero"
        className="w-full h-full bg-[#F2D07A] flex flex-col justify-center items-center overflow-hidden"
      >
      ...
      <section id="news">
        <div className="flex justify-center items-center">
          <div className="bg-[#906A0B] lg:w-[600px] w-96 h-16 rounded-xl -mt-8 mb-12">
        ...
        <div class="container px-5 py-24 mx-auto wrapper">
